...
- 仓库：[RCAEval models](../../backend/benchmarks/rcaeval/models.py)、[runner](../../backend/benchmarks/rcaeval/runner.py)、[audit](../../backend/benchmarks/rcaeval/audit.py)、[evaluation chapter](08-评测与测试.md)。
