...
| Run hard deadline | 120 seconds (amended 2026-08-15, SS30 operational-noise chain: benchmark formal runs may raise the frozen deadline up to 300 seconds with explicit per-launch user authorization; product default and server maximum stay 120) |
