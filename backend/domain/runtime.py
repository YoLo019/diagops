    ...
    _EVENT_PAYLOAD_KEYS[_event_type] |= frozenset(
        {
            ...
            "input_estimate_estimated_tokens",
            "input_estimate_instruction_chars",
            "input_estimate_context_chars",
            "input_estimate_total_chars",
            "input_estimate_chars",
            "input_estimate_ascii_plain_chars",
            "input_estimate_cjk_chars",
            "input_estimate_non_ascii_chars",
            "input_estimate_json_punctuation_chars",
            "input_estimate_input_chars",
            "input_estimate_input_estimated_tokens",
            "input_estimate_input_cjk_chars",
            "input_estimate_input_json_punctuation_chars",
            "input_estimate_tools_chars",
            "input_estimate_tools_estimated_tokens",
            "input_estimate_tools_cjk_chars",
            "input_estimate_tools_json_punctuation_chars",
            "input_estimate_output_schema_chars",
            "input_estimate_output_schema_estimated_tokens",
            "input_estimate_output_schema_cjk_chars",
            "input_estimate_output_schema_json_punctuation_chars",
            "model_turn_budget",
